...
def fetch_leipzig_listings(max_price=None, min_price=None, max_qm=None, min_qm=None, radius=None):
    ...
    # Leipzig-spezifische Werte
    location_area = "leipzig%2C-zentrum"  # Leipzig, Zentrum
    location_code = "l4278"  # Leipzig Location Code
    location_radius = radius if radius else 20
    ...
    while True:
        ...
        if page == 1:
            ...
            # URL für weitere Seiten dynamisch erstellen
            url = f"https://www.kleinanzeigen.de/s-wohnung-kaufen/{location_area}/"
            ...
            # Basis-Kategorie hinzufügen
            url += f"c196{location_code}r{location_radius}"
